...
package com.yintong.auth.pay.utils;
...
public class MobileSecurePayer {
    ...
    public boolean payNewAuthSign(String strOrderInfo, final Handler callback,
                                  final int myWhat, final Activity activity, boolean isTest) {

        return pay(strOrderInfo, callback, myWhat, activity, "4", true, isTest);
    ...
    public boolean payNewAuth(String strOrderInfo, final Handler callback,
                              final int myWhat, final Activity activity, boolean isTest) {

        return pay(strOrderInfo, callback, myWhat, activity, "4", false, isTest);
